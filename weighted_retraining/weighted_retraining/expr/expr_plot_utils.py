...
from weighted_retraining.weighted_retraining.robust_opt_scripts.robust_opt_expr_pseudo import get_root_path
...
class RobustExprRegretPlotter(RegretPlotter):
    ...
    def __init__(self, budget: int, lso_strategy: str, weight_type, k: float, r: int, predict_target: bool,
                 target_predictor_hdims: List[int], acq_func_id: str,
        ...
        super().__init__(budget=budget,
                         ...
                         target_predictor_hdims=target_predictor_hdims, acq_func_id=acq_func_id, covar_name=covar_name,
