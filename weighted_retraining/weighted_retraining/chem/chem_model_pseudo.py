...
from weighted_retraining.weighted_retraining.models_pseudo_chem import BaseVAE, MLPRegressor
...
class JTVAE(BaseVAE):
    ...
    def ssdkl_loss(self, z: Tensor, target: Tensor, ulz: Tensor=None, alpha: float=1.0):
        ...
        y_pred, y_std = dist.mean, dist.variance
