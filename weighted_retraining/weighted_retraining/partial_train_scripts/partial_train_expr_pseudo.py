...
from weighted_retraining.weighted_retraining.expr.expr_data_pseudo import WeightedExprDataset
...
def get_path(k, ignore_percentile, good_percentile, predict_target: bool, n_max_epochs: int,
...
def main():
    ...
    hparams.root_dir = get_path(k=hparams.rank_weight_k, ignore_percentile=hparams.ignore_percentile,
                                good_percentile=hparams.good_percentile, n_max_epochs=hparams.max_epochs,
                                predict_target=hparams.predict_target, beta_final=hparams.beta_final,
